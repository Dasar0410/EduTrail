...
int main(){
    ...
    if(gMainFile.tellg()==0){   //lager newline med mindre det er begynnelsen av filen.
        gMainRebus->readData();
...
void showSettings(){
    ...
    do{
        ...
        switch(command){
            ...
            case 2: createSpace(100); save(gMainFile); load(gMainFile); break;
            case 3: createSpace(100); save(gMainFile); load(gMainFile); newRebus(); break;
